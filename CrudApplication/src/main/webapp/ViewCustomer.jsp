...
<body>
	...
	<div class="addCustomerbtn">
		<button><a href="CreateCustomer.jsp">Add Customer</a></button>
	</div>
	...
	<div class="row">
		...
		<div class="col"><input required="required" name="content"> </div>
	...
	<table class="table table-bordered">
		...
		<tbody>
			<%
				...
				List<CustomerEntity> list = dao.DisplayCustomer();
